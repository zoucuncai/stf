...
module.exports.builder = function(yargs) {
  ...
  return yargs
    ...
    .option('kill-apps-on-release', {
      describe: 'On release, stop third-party app processes after going home ' +
        '(see device --kill-apps-on-release). Negate with --no-kill-apps-on-release.'
    , type: 'boolean'
    , default: true
    })
...
module.exports.handler = function(argv) {
  ...
  , fork: function(device, ports) {
      ...
      .concat(!argv.killAppsOnRelease ? ['--no-kill-apps-on-release'] : [])
